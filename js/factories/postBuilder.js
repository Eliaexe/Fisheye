class postFactory {
    formatPost(element){ 
        ...
        <div class="ph-work-elt-text">
            ...
            <p class="ph-work-price focusable" tabindex="0" aria-label="the price is">${element.price}€</p>
            <div class='ph-work-like-div'>
                <p class="like-counter focusable" tabindex="0" aria-label="likes">${element.likes}</p>
