class PhotographerHeader {
    display(data) {
            ...
            const template = `
                <div class='ph-infos focusable' tabindex="0" aria-label="My name is ${photographers[0].name}, i live in ${photographers[0].city}, ${photographers[0].country} and my tagline is ${photographers[0].tagline}">
